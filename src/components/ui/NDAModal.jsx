      ...
      <div className="space-y-4 text-slate-300">
        <section>
          ...
          <ul className="space-y-2 list-disc list-inside">
            ...
            <li>Contact details cannot be shared outside WareX</li>
            <li>Users cannot bypass WareX for direct transactions</li>
        ...
        <section>
          ...
          <p className="text-slate-300">
            Violation of this Non-Disclosure Agreement may lead to immediate account suspension, legal action, and permanent ban from the WareX platform.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-slate-300">
            WareX monitors transactions to ensure compliance. Any attempts to circumvent the platform or expose confidential information will be detected and penalized accordingly.
          </p>
        </section>
