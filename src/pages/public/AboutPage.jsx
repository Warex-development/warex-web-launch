...
export default function AboutPage() {
  ...
  return (
    <div className="space-y-20 py-20">
      ...
      >
        <h1 className="text-5xl font-bold text-[#1A1A1A] mb-2">About WareXhub</h1>
        ...
        <p className="text-2xl font-bold text-[#4A3A5C] max-w-4xl mx-auto mb-8">
          WareXhub — The Common Bank for Industrial Equipments and Parts
        </p>
      </motion.div>
      ...
      >
        <p>
          At WareXhub, we are redefining how industries manage non-moving inventory.
        ...
        <p>
          WareXhub connects seller industries with idle inventory to buyer industries with urgent requirements — all through a secure, technically validated, and professionally managed platform.
        </p>

        <div className="bg-white border border-[#E5E5E5] rounded-xl p-8 shadow-sm">
          <h3 className="text-xl font-bold text-[#1A1A1A] mb-4">Unlike conventional marketplaces, WareXhub actively participates in every transaction by ensuring:</h3>
        ...
        <div className="bg-[#F8F8FA] border border-[#E5E5E5] rounded-xl p-8">
          <h3 className="text-xl font-bold text-[#1A1A1A] mb-4">By turning unused industrial stock into opportunity, WareXhub helps industries:</h3>
        ...
        <p className="text-xl text-center font-medium leading-relaxed">
          Whether it is boilers, pumps, instrumentation, water treatment systems, compressors, or factory consumables — WareXhub creates one common platform where industries trade with confidence and reliance.
        </p>

        <div className="text-center py-12 border-t border-[#E5E5E5]">
          <h2 className="text-3xl font-black text-[#1A1A1A] mb-4">WareXhub is more than a marketplace.</h2>
      ...
      >
        ...
        <p className="text-[#333333] mb-8 max-w-2xl mx-auto">
          Whether you're sourcing rare parts or listing your inventory, WareXhub is your trusted platform.
        </p>
        <button
